        ...
        >
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring" } } }} className="footer-dark__col">
            ...
            <ul className="footer-dark__list">
              ...
              <li><Link href="/branches">Nos branches</Link></li>
              <li><Link href="/formations">Catalogue formations</Link></li>
              <li><Link href="/inscrire">S&apos;inscrire</Link></li>
            </ul>
          </motion.div>

          {/* Column 3: Services / Branches */}
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring" } } }} className="footer-dark__col">
            <h4 className="footer-dark__heading">NOS BRANCHES</h4>
            <ul className="footer-dark__list">
              <li><Link href="/branches/admin-gestion">Techniques administratives</Link></li>
              <li><Link href="/branches/it-numerique">Informatique & Numérique</Link></li>
              <li><Link href="/branches/chimie-qhse">Chimie industrielle & QHSE</Link></li>
              <li><Link href="/branches/art-graphiques">Art & Graphiques</Link></li>
              <li><Link href="/branches">Voir toutes les branches...</Link></li>
            </ul>
          </motion.div>
